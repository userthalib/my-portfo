    ...
    projects: {
      ...
      items: {
        nebula: {
          ...
          longDesc: "An one stop all in one integrated ERP website designed for non IT user that covers HR work, sales, procurement, sales, accounting and many more.",
          category: "2025",
        },
        velox: {
          title: "SIPROPER PUSAKA",
          description: "Headless e-commerce with perfect Lighthouse scores.",
          longDesc: "A simple one paged website that help field nurses to read, write, and process patient data from a raw xlsx or csv file.",
          category: "2025",
        },
        sync: {
          title: "Cluster LIB",
          description: "Offline-first productivity PWA.",
          longDesc: "A minimalist exam system that help lecturer to grade answer from essay type questions with the help of machine learning.",
          category: "2023",
        },
      },
    },
    ...
    projects: {
      ...
      items: {
        nebula: {
          ...
          longDesc: "Situs web ERP terintegrasi all-in-one dan serba ada yang dirancang untuk pengguna non-IT, mencakup pekerjaan SDM (HR), penjualan, pengadaan (procurement), akuntansi, dan banyak lagi.",
          category: "2025",
        },
        velox: {
          title: "SIPROPER PUSAKA",
          description: "E-commerce headless dengan skor Lighthouse sempurna.",
          longDesc: "Situs web satu halaman sederhana yang membantu perawat lapangan untuk membaca, menulis, dan mengolah data pasien dari file mentah format .xlsx atau .csv.",
          category: "2025",
        },
        sync: {
          title: "Cluster LIB",
          description: "PWA produktivitas offline-first.",
          longDesc: "Sistem ujian minimalis yang membantu dosen untuk menilai jawaban dari pertanyaan tipe esai dengan bantuan machine learning (pembelajaran mesin).",
          category: "2023",
        },
      },
    },
